...
import voyatrip.logic.command.exceptions.InvalidChangeDirectory;
...
public class Executor {
    ...
    private static void handleInput(String input) {
        ...
        } catch (InvalidChangeDirectory e){
            logger.log(Level.WARNING, "Invalid change directory");
            Ui.printInvalidChangeDirectory();
